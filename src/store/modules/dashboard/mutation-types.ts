...
export const SET_GET_EVENTS_ERRORS = 'SET_GET_EVENTS_ERRORS';
export const SET_SERVICE_ERRORS = 'SET_SERVICE_ERRORS';
...
export const SET_INSTANCE_ERRORS = 'SET_INSTANCE_ERRORS';
export const SET_ENDPOINT_ERRORS = 'SET_ENDPOINT_ERRORS';
