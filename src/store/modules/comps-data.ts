...
const initState: State = {
  data: {
    service: [
      ...
      comp: 'ChartCpu', title: 'JVM CPU %' , width: 3 },
      { o: 'ServiceInstance', name: 'Instance JVM GC',
      comp: 'ChartGC', title: 'JVM GC (ms)' , width: 3 },
      { o: 'ServiceInstance', name: 'Instance JVM Heap',
      comp: 'ChartHeap', title: 'JVM Heap (MB)' , width: 3 },
      { o: 'ServiceInstance', name: 'Instance JVM NonHeap',
      comp: 'ChartNonHeap', title: 'JVM Non-Heap MB' , width: 3 },
      { o: 'ServiceInstance', name: 'Instance CLR CPU',
      comp: 'ChartClrCPU', title: 'CLR CPU %' , width: 3 },
      { o: 'ServiceInstance', name: 'Instance CLR Heap',
      comp: 'ChartClrHeap', title: 'CLR HeapMemory (MB)' , width: 3 },
      { o: 'ServiceInstance', name: 'Instance CLR GC',
      comp: 'ChartClrGC', title: 'CLR GC (Count)' , width: 3 },
