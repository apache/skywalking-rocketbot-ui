...
export const queryDependencyInstanceMetric = `query queryDependencyInstanceMetric(
  ${DependencyInstanceMetric.variable}) {${DependencyInstanceMetric.query}}`;
