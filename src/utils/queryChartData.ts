...
export const queryChartData = {
  service: [
    ...
    {o: 'ServiceDependency', d: 'dependencyServerResponseTimeTrend',
      c: 'ChartLine', t: 'Server Response Time Trend', w: 3, h: 250},
    {o: 'ServiceDependency', d: 'dependencyClientResponseTimeTrend',
      c: 'ChartLine', t: 'Client Response Time Trend', w: 3, h: 250},
    {o: 'ServiceDependency', d: 'dependencyServerThroughputTrend',
      c: 'ChartLine', t: 'Server Throughput Trend', w: 3, h: 250},
    {o: 'ServiceDependency', d: 'dependencyClientThroughputTrend',
      c: 'ChartLine', t: 'Client Throughput Trend', w: 3, h: 250},
    {o: 'ServiceDependency', d: 'dependencyServerSLATrend',
      c: 'ChartLine', t: 'Server SLATrend', w: 3, h: 250},
    {o: 'ServiceDependency', d: 'dependencyClientSLATrend',
      c: 'ChartLine', t: 'Client SLATrend', w: 3, h: 250},
  ],
  proxy: [],
  database: [
      // global
