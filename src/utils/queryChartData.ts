...
export const queryChartData = {
  service: [
    ...
    {o: 'ServiceDependency', d: 'TopoServiceInfo', c: 'ChartLine', t: 'Server Response Time Percentile', w: 3, h: 250},
    {o: 'ServiceDependency', d: 'TopoClientInfo', c: 'ChartLine', t: 'Client Response Time Percentile', w: 3, h: 250},
  ],
  proxy: [],
  database: [
      // global
