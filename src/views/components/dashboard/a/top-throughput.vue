...
export default class RkTopThroughput extends Vue {
  ...
  get fiveData() {
    return this.stateDashboard.global.getTopNServiceThroughput.length < 6
    ?
    this.stateDashboard.global.getTopNServiceThroughput
    :
    this.stateDashboard.global.getTopNServiceThroughput.splice(0, 4);
  }
  get maxValue() {
