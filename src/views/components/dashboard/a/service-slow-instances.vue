<template>
<rk-panel class="rk-service-instance" title="Service Instances Throughput">
...
export default class RkTopThroughput extends Vue {
  ...
  get fiveData() {
    return this.stateDashboard.serviceInfo.getInstanceThroughput.length < 6
    ?
    this.stateDashboard.serviceInfo.getInstanceThroughput
    :
    this.stateDashboard.serviceInfo.getInstanceThroughput.splice(0, 4);
  }
  get maxValue() {
